...
export default function Hero() {
  return (
    <section className="relative flex items-center min-h-[500px] py-24 px-0 w-full bg-gradient-to-r from-red-50 to-white overflow-hidden border-y-2 border-gray-200">
      <div className="flex flex-row items-center w-full max-w-7xl mx-auto px-12 gap-12">
        ...
        <div className="flex flex-col gap-6 flex-1 items-end justify-center max-w-2xl">
          <img src="/Images/SweeperTruck1.jpg" alt="Sweeper Truck 1" className="rounded-2xl shadow-2xl w-full h-[320px] object-cover border border-gray-200" />
          <img src="/Images/SweeperTruck2.jpg" alt="Sweeper Truck 2" className="rounded-2xl shadow-xl w-full h-[240px] object-cover border border-gray-200 ml-auto" />
        </div>
      </div>
    </section>
  )
