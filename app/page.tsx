    ...
    <main className="flex flex-col items-center justify-center min-h-screen">
      ...
      <section className="w-full bg-red-700 flex flex-col items-center py-8 sm:py-12 px-2">
        <div className="flex flex-col md:flex-row gap-6 md:gap-10 justify-center w-full max-w-6xl">
          <div className="bg-gray-100 rounded-2xl p-4 sm:p-8 md:p-12 shadow-xl w-full md:w-96 min-h-45 flex flex-col items-start mb-4 md:mb-0">
          ...
          <div className="bg-gray-100 rounded-2xl p-4 sm:p-8 md:p-12 shadow-xl w-full md:w-96 min-h-45 flex flex-col items-start">
